...
def preprocessar_dataframe(df_raw: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, dict]:
    ...
    """
    Etapa 4b: Sinalização de anos implausíveis em datas tecnicamente válidas
    ...
    relatorio = {
        ...
        "decisoes_filtragem": [
            ...
            "Datas com ano fora do intervalo observado em 'ano' sinalizadas "
            "em 'anos_implausiveis' (não removidas — provável corrupção de "
            "dígitos na fonte; ex.: '0202-05-04' em vez de '2020-05-04').",
        ],
    }
